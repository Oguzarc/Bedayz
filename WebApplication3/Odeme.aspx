<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Odeme.aspx.cs" Inherits="WebApplication3.Odeme" %>
        ...
        <div id="wrapper">
         ...
         <div class="Uyelik">
             <div class="uyelikic">
                 <div class="UyeGiris">
              <div>
            <asp:Label ID="Label1" runat="server" Text="KART BİLGİLERİ"></asp:Label>
            <br />
            <br />
            <asp:TextBox ID="kartno" runat="server" placeholder="Kart No" CssClass="TextBox"></asp:TextBox>
            <br />
            <br />
            <asp:TextBox ID="cvv" runat="server" placeholder="CVV"  CssClass="TextBox"></asp:TextBox>
            <br />
            <br />
            <asp:TextBox ID="ay" runat="server" placeholder="Ay" CssClass="TextBox"></asp:TextBox>
            <br />
            <br />
            <asp:TextBox ID="yil" runat="server" placeholder="Yıl" CssClass="TextBox"></asp:TextBox>
            <br />
            <br />
            <asp:Button ID="odeme" runat="server" Text="ÖDEME YAP"  OnClick="girisyap_Click" CssClass="UyeButon" />

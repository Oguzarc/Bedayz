<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Urun10Sayfa.aspx.cs" Inherits="WebApplication3.Urun10Sayfa" %>
...
<body>
    <form id="form1" runat="server">
            ...
            <div class="UrunSayfa">
                <div class="UrunAlan">
                <asp:Image runat = "server" ImageUrl="/Images/hd4.jpg" Height="478" Width="340" cssClass="UrunSayfaResim" /> 
                <asp:Label Font-Size="37px" Font-Bold="true" runat="server" CssClass="UrunAdi">ILLEGAL | Bedayz</asp:Label> 
                <asp:Label Font-Size="37px" runat="server" CssClass="UrunFiyat">₺119,90</asp:Label> // ÜRÜN FİYATI
                <asp:Button runat = "server" Text="Sepete Ekle" Height="75" Width="350" CssClass="UrunSepet" BackColor="Yellow" Font-Size="Large" Font-Bold="True" OnClick="Urun10S_Click" />

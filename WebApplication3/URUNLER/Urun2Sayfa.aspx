<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Urun2Sayfa.aspx.cs" Inherits="WebApplication3.Urun2Sayfa" %>
...
<body>
    <form id="form1" runat="server">
          ...
          <header>
            ...
            <div class="UrunSayfa">
                <div class="UrunAlan">
                <asp:Image runat = "server" ImageUrl="/Images/es2.jpg" Height="478" Width="340" cssClass="UrunSayfaResim" /> 
                <asp:Label Font-Size="37px" Font-Bold="true" runat="server" CssClass="UrunAdi">WHITE STAY HIGH | Bedayz</asp:Label> 
                <asp:Label Font-Size="37px" runat="server" CssClass="UrunFiyat">₺69,90</asp:Label> 
                <asp:Button runat = "server" Text="Sepete Ekle" Height="75" Width="350" CssClass="UrunSepet" BackColor="Yellow" Font-Size="Large" Font-Bold="True" OnClick="Urun2S_Click" />

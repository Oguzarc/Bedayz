<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Urun6Sayfa.aspx.cs" Inherits="WebApplication3.Urun6Sayfa" %>
...
<body>
    <form id="form1" runat="server">
          ...
          <div class="UrunArkaGri">
            <div class="UrunSayfa">
                <div class="UrunAlan">
                <asp:Image runat = "server" ImageUrl="/Images/es6.jpg" Height="478" Width="340" cssClass="UrunSayfaResim" />
                <asp:Label Font-Size="37px" Font-Bold="true" runat="server" CssClass="UrunAdi">FLASH SILVER KOLYE | Bedayz</asp:Label> 
                <asp:Label Font-Size="37px" runat="server" CssClass="UrunFiyat">₺39,90</asp:Label> 
                <asp:Button runat = "server" Text="Sepete Ekle" Height="75" Width="350" CssClass="UrunSepet" BackColor="Yellow" Font-Size="Large" Font-Bold="True" OnClick="Urun6S_Click" />
